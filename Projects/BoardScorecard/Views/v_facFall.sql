...
/****** Object:  View [BoardScorecard].[v_facFall]    Script Date: 9/19/2023 9:18:48 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [BoardScorecard].[v_facFall] AS
...
from(
	select 
		f.* 
		,case when FallUnitID in (682892/*CICU*/,684077/*ICU*/,43697268/*CVICU*/) then 1 else 0 end as CC
